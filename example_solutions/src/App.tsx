...
import FailuresPerInstallYear from "./dashboardElements/otherExamples/FailuresPerInstallYear";
import Installed from "./dashboardElements/otherExamples/Installed";
